...
def handle_updates(updates):
    ...
    for update in updates["result"]:
        ...
        if text == "/help":
            cur_cmd = "hp"
            send_message("Fala, *twospleik*! Eu rankeio os membros Twonai pelos atrasos " + 
                "que ele cometem no setor de dev da Polibrás.\n\n Esses são meus comandos: \n\n" + 
                " /rank - Ranking dos atrasados \n" + 
                " /adddelay - Adicionar atraso \n" + 
                " /addmember - Adicionar membro \n" + 
                " /deleteall - Deletar todos os membros \n" + 
            ...
            if members:
                ...
                for member in members:
                    msg += member.name + ": " + str(member.delay_number) + " atrasos" + "\n"
